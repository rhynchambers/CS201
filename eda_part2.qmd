...
-   Whiskers: range from mininum to maximum exlcuding outliers +/- 1.5 sd
...
ggplot(diamonds, aes(x = carat, y = price)) +
  geom_point(alpha=0.05) # try making the points transparent to 0.1
```
...
```{r}
ggplot(kbodata, aes(x = year, y = era)) +
